                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_pharmacist/hospital_activities/medicine/form/'.$medicine->id,'class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('category_id',html_escape($category_list), $medicine->category_id, 'class="form-control" id="category_id"') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="price"  type="number" class="form-control" id="price" placeholder="<?php echo display('price')?>" value="<?php echo $medicine->price ?>">
                                </div>
                            </div>
