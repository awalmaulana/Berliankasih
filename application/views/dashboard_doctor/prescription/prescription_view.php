                        ...
                        <table class="table">
                            <thead>
                                <tr  class="bg-primary">
                                    ...
                                    <td  class="text-right"><strong><?php echo display('date') ?></strong>: <?php echo html_escape(date('m/d/Y', strtotime($prescription->date))); ?>
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
                            ...
                            <tfoot>
                                <tr class="bg-primary">
                                    <td colspan="2">
                                        ...
                                        <strong><?php echo display('age') ?></strong>: <?php echo html_escape("$diff->y Years $diff->m Months"); ?>,
