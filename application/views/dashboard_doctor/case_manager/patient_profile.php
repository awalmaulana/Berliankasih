                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9"> 
                                <dl class="dl-horizontal">
                                    ...
                                    </dt><dd><?php echo html_escape(date('d M Y',strtotime($profile->date_of_birth))) ?> (<?php echo html_escape(date_diff(date_create($profile->date_of_birth), date_create('now'))->y); ?> Years)</dd> 
