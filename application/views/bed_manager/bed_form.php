            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('bed_manager/bed/form/'.html_escape($bed->id),'class="form-inner"') ?>

                            <?php echo form_hidden('id',html_escape($bed->id)) ?>

                            <div class="form-group row">
                                <label for="type" class="col-xs-3 col-form-label"><?php echo display('bed_type') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="type"  type="text" class="form-control" id="type" placeholder="<?php echo display('bed_type') ?>" value="<?php echo html_escape($bed->type) ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="limit"  type="number" class="form-control" id="limit" placeholder="<?php echo display('bed_limit') ?>" value="<?php echo html_escape($bed->limit); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="charge"  type="number" class="form-control" id="charge" placeholder="<?php echo display('charge') ?>" value="<?php echo html_escape($bed->charge); ?>">
                                </div>
                            </div>
