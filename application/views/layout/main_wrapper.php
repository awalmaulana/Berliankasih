                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(1) == "doctor") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("dokter/create") ?>"><?php echo display('add_doctor') ?></a></li>
                                <li><a href="<?php echo base_url("dokter") ?>"><?php echo display('doctor_list') ?></a></li> 
                            </ul>
                        </li>
                         <li class="treeview <?php echo (($this->uri->segment(1) == "department") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("poliklinik/create") ?>"><?php echo display('add_department') ?></a></li>
                                <li><a href="<?php echo base_url("poliklinik") ?>"><?php echo display('department_list') ?></a></li> 
                            </ul>
                        </li>

                      

                         <li class="treeview <?php echo (($this->uri->segment(1) == "pasien") ? "active" : null) ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("pasien/create") ?>"><?php echo display('add_patient') ?></a></li>
                                <li><a href="<?php echo base_url("pasien") ?>"><?php echo display('patient_list') ?></a></li> 
                                <!-- <li><a href="<?php echo base_url("pasien/document_form") ?>"><?php echo display('add_document') ?></a></li> 
                                <li><a href="<?php echo base_url("pasien/document") ?>"><?php echo display('document_list') ?></a></li>  -->
                            </ul>
                        </li> 
                         <li class="treeview <?php echo (($this->uri->segment(1) == "account_manager") ? "active" : null) ?>">
                          ...
                          <li class="treeview  <?php echo (($this->uri->segment(1) == "pegawai") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-users"></i> <span><?php echo 'Data Pegawai' ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("pegawai/employee/form") ?>"><?php echo display('add_employee') ?></a></li>
                                <li><a href="<?php echo base_url("pegawai/employee/index/keuangan") ?>"><?php echo display('accountant_list') ?></a></li>
                                <li><a href="<?php echo base_url("pegawai/employee/index/labotorium") ?>"><?php echo display('laboratorist_list') ?></a></li>
                                <li><a href="<?php echo base_url("pegawai/employee/index/perawat") ?>"><?php echo display('nurse_list') ?></a></li>
                                <li><a href="<?php echo base_url("pegawai/employee/index/apotek") ?>"><?php echo display('pharmacist_list') ?></a></li>
                                <li><a href="<?php echo base_url("pegawai/employee/index/resepsionis") ?>"><?php echo display('receptionist_list') ?></a></li>
                                <li><a href="<?php echo base_url("pegawai/employee/index/kasir") ?>"><?php echo 'Kasir' ?></a></li>
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1><?php echo str_replace('_', ' ', ucfirst($this->uri->segment(1))) ?> <?php echo str_replace('_', ' ', ucfirst($this->uri->segment(4))) ?></h1>
