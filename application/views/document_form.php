    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail"> 
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("pasien/document") ?>"> <i class="fa fa-list"></i>  <?php echo display('document_list') ?> </a>  
                </div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('pasien/document_form','class="form-inner" id="mailForm" ') ?>
