        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php echo form_open('sms/sms_setup_controller/sms_setting') ?>
                    <?php echo form_hidden('id', html_escape($sms_setting->id)) ?>
                    
                  <div class="checkbox checkbox-success">
                        <input id="appointment" type="checkbox" name="appointment" <?php echo html_escape((($sms_setting->appointment==1)?'checked':null)); ?>>
                        <label for="appointment"><?php echo display('appointment') ?></label>
                  </div>
                  <div class="checkbox checkbox-success">
                        <input id="registration" type="checkbox" name="registration" <?php echo html_escape((($sms_setting->registration==1)?'checked':null)); ?>>
                        <label for="registration"><?php echo display('registration') ?></label>
                  </div>
                  <div class="checkbox checkbox-success">
                        <input id="schedule" type="checkbox" name="schedule" <?php echo html_escape((($sms_setting->schedule==1)?'checked':null)); ?>>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr> 
                            ...
                            <td><input type="radio" <?php echo html_escape($value->default_status==1?'checked':'');?> class="form-control"></td>
