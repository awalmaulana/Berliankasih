                                            ...
                                            <?php foreach ($documents as $document) { ?>
                                                <tr>
                                                    ...
                                                    <td class="center no-print" width="110"> 
                                                        ...
                                                        <a href="<?php echo base_url("pasien/document_form/$document->patient_id") ?>" class="btn btn-xs btn-warning" title="Add Document"><i class="fa fa-plus"></i></a> 
                                                        ...
                                                        <a href="<?php echo base_url("pasien/document_delete/$document->id?file=$document->hidden_attach_file") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fa fa-trash"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php $sl++; ?>
                                            <?php } ?> 
