            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        <?php echo form_open('account_manager/invoice/edit/'.html_escape($invoice->id)) ?> 
                        <?php echo form_hidden('id',html_escape($invoice->id)) ?>
                        ...
                        <table id="invoice" class="table table-striped"> 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <?php echo form_dropdown('account_id[]', $debit_account_list, html_escape($value->account_id) , 'class="dont-select-me form-control" html_escape(required'); ?>
                                    </td> 
                            ...
                            <tfoot> 
                                <tr class="bg-info">  
                                    ...
                                    <th><input type="number" name="total" id="total" class="form-control" readonly required placeholder="<?php echo display('total') ?>"  value="<?php echo $invoice->total ?>"></th>  
                                    <td></td> 
                                </tr>
                                <tr>  
                                    ...
                                    <td><input type="number" name="vat" id="vat" required autocomplete="off"  class="vatDiscount paidDue form-control" placeholder="<?php echo display('vat') ?>" value="<?php echo $invoice->vat ?>"></td>  
                                    <td></td> 
                                </tr>
                                <tr>  
                                    ...
                                    <td><input type="number" name="discount" required autocomplete="off" id="discount" class="vatDiscount paidDue form-control" placeholder="<?php echo display('discount') ?>"  value="<?php echo $invoice->discount ?>"></td> 
                                    <td></td>  
                                </tr> 
                                <tr class="bg-success">  
                                    <td colspan="3"></td>  
                                    <th class="text-right"><?php echo display('grand_total') ?></th>  
                                    <th><input type="number" name="grand_total" readonly required autocomplete="off"  id="grand_total" class="paidDue form-control" placeholder="<?php echo display('grand_total') ?>" value="<?php echo $invoice->grand_total ?>"></th> 
                                    <td></td>  
                                </tr>
                                <tr>  
                                    <td colspan="3"></td>  
                                    <th class="text-right"><?php echo display('paid') ?></th>
                                    <td><input type="number" name="paid" id="paid" autocomplete="off"  class="paidDue form-control" required placeholder="<?php echo display('paid') ?>"  value="<?php echo $invoice->paid ?>"></td> 
                                    <td></td>  
                                </tr>
                                <tr class="bg-danger">  
                                    <td colspan="3"></td>  
                                    <th class="text-right"><?php echo display('due') ?></th> 
                                    <td><input type="number" name="due" id="due" autocomplete="off" class="paidDue form-control" required placeholder="<?php echo display('due') ?>" value="<?php echo $invoice->due ?>"></td> 
                                    <td></td>  
                                </tr>
                                <tr>  
                                    <td colspan="3">
