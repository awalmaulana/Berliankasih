                    ...
                    <tbody>
                        <?php if (!empty($patients)) { ?>
                            ...
                            <?php foreach ($patients as $patient) { ?>
                                <tr>
                                    <td><?php echo $sl; ?></td>
                                    <td><a href="<?php echo base_url("/case_manager/patient/profile/$patient->id"); ?>"><?php echo html_escape($patient->patient_id) ?></a></td>
                                    <td><?php echo html_escape($patient->patient_name); ?></td>
                                    <td><?php echo html_escape($patient->mobile); ?></td>
                                    <td><?php echo html_escape($patient->case_manager); ?></td>
                                    <td><?php echo html_escape($patient->ref_doctor_name); ?></td>
                                    <td><?php echo html_escape($patient->hospital_name); ?></td>
                                    <td><?php echo html_escape($patient->date); ?></td> 
