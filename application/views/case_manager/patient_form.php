                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('case_manager/patient/form') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="patient_id" type="text" class="form-control" id="patient_id" placeholder="<?php echo display('patient_id') ?>" value="<?php echo html_escape($patient->patient_id); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('case_manager_id',$case_manager_list , html_escape($patient->case_manager_id),'class="form-control" id="case_manager_id"') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('ref_doctor_id',$doctor_list , html_escape($patient->ref_doctor_id),'class="form-control" id="ref_doctor_id"') ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="hospital_name" type="text" class="form-control" id="hospital_name" placeholder="<?php echo display('hospital_name') ?>" value="<?php echo html_escape($patient->hospital_name); ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="hospital_address" class="form-control"  placeholder="<?php echo display('hospital_address') ?>" maxlength="140" rows="7"><?php echo html_escape($patient->hospital_address); ?></textarea>
                                </div>
                            </div> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="doctor_name" type="text" class="form-control" id="doctor_name" placeholder="<?php echo display('doctor_name') ?>" value="<?php echo html_escape($patient->doctor_name); ?>" >
                                </div>
                            </div> 
 
                            <div class="form-group row">
                                <label class="col-xs-3"><?php echo display('status') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
