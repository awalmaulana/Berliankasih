                    ...
                    <tbody>
                        <?php if (!empty($advances)) { ?>
                            ...
                            <?php foreach ($advances as $advance) { ?>
                                <tr>
                                    <td><?php echo $sl++; ?></td>
                                    <td><?php echo html_escape($advance->admission_id); ?></td>
                                    <td><?php echo html_escape($advance->patient_id); ?></td>
                                    <td><?php echo html_escape($advance->amount); ?></td>
                                    <td><?php echo html_escape($advance->payment_method); ?></td>
                                    <td><?php echo html_escape($advance->cash_card_or_cheque); ?></td>
                                    <td><?php echo html_escape($advance->receipt_no); ?></td>
                                    <td><?php echo html_escape($advance->date); ?></td>
                                    <td class="center">
