            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php echo form_open('billing/package/edit/'.html_escape($package->id),'class="form-inner"') ?>
                            <?php echo form_hidden('id',html_escape($package->id)); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                ...
                                                for($i=0;$i<count($services);$i++)
                                                {
                                                    ...
                                                    { 
                                                        echo "<tr>";
                                                        echo "<td><input name=\"service_name[]\" class=\"form-control service_name service_data\" type=\"text\" placeholder=".display('service_name')." value='".html_escape($services[$i]['name'])."'><input type=\"hidden\" name=\"service_id[]\" class=\"service_id\" value='".html_escape($services[$i]['id'])."'></td>";
                                                        echo "<td><input name=\"quantity[]\" class=\"form-control quantity\" type=\"number\" placeholder=".display('quantity')." value='".html_escape($services[$i]['quantity'])."'></td>";
                                                        echo "<td><input name=\"amount[]\" class=\"form-control amount\" type=\"number\" placeholder=".display('amount')." value='".html_escape($services[$i]['amount'])."'></td>";
