                        ...
                        <?php if (!empty($packages)) { ?>
                            ...
                            <?php foreach ($packages as $package) { ?>
                                <tr>
                                    ...
                                    <td><?php echo html_escape(character_limiter($package->description, 60)); ?></td> 
                                    <td><?php echo html_escape($package->discount); ?></td>
                                    <td><?php echo ((html_escape($package->status)==1)?display('active'):display('inactive')); ?></td>
                                    <td class="center">
