                        ...
                        <?php if (!empty($services)) { ?>
                            ...
                            <?php foreach ($services as $service) { ?>
                                <tr>
                                    ...
                                    <td><?php echo html_escape(character_limiter($service->description, 60)); ?></td>
                                    <td><?php echo html_escape($service->quantity); ?></td>
                                    <td><?php echo html_escape($service->amount); ?></td>
                                    <td><?php echo ((html_escape($service->status)==1)?display('active'):display('inactive')); ?></td>
                                    <td class="center">
