                        ...
                        <?php echo form_open('schedule/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9"> 
                                    <?php 
                                        ...
                                        echo form_dropdown('available_days',$AvailableDays,html_escape($schedule->available_days),'class="form-control" id="available_days"'); 
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input name="start_time" class="timepicker form-control" type="text" placeholder="<?php echo display('start_time') ?>" value="<?php echo html_escape($schedule->start_time); ?>">
                                        </div>
                                        <div class="col-xs-6">
                                            <input name="end_time" class="timepicker form-control" type="text" placeholder="<?php echo display('end_time') ?>"  value="<?php echo html_escape($schedule->end_time); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input class="timepicker-hour-min-only form-control" name="per_patient_time" type="text" placeholder="<?php echo display('per_patient_time') ?>" id="per_patient_time"  value="<?php echo html_escape($schedule->per_patient_time); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9"> 
                                    <?php 
                                        ...
                                        echo form_dropdown('serial_visibility_type',$visibilityTypes,html_escape($schedule->serial_visibility_type),'class="form-control" id="serial_visibility_type"'); 
                                    ?>
