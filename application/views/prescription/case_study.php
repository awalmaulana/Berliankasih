                    ...
                    <tbody>
                        <?php if (!empty($case_studys)) { ?>
                            ...
                            <?php foreach ($case_studys as $case_study) { ?>
                                <tr>
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($case_study->patient_id); ?></td>
                                    <td><?php echo html_escape($case_study->food_allergies); ?></td>
                                    <td><?php echo html_escape($case_study->tendency_bleed); ?></td>
                                    <td><?php echo html_escape($case_study->heart_disease); ?></td>
                                    <td><?php echo html_escape($case_study->high_blood_pressure); ?></td>
                                    <td><?php echo html_escape($case_study->diabetic); ?></td>
                                    <td><?php echo html_escape($case_study->surgery); ?></td>
                                    <td><?php echo html_escape($case_study->accident); ?></td>
                                    <td><?php echo html_escape($case_study->others); ?></td>
                                    <td><?php echo html_escape($case_study->family_medical_history); ?></td>
                                    <td><?php echo html_escape($case_study->current_medication); ?></td>
                                    <td><?php echo html_escape($case_study->female_pregnancy); ?></td>
                                    <td><?php echo html_escape($case_study->breast_feeding); ?></td>
                                    <td><?php echo html_escape($case_study->health_insurance); ?></td>
                                    <td><?php echo html_escape($case_study->low_income); ?></td>
                                    <td><?php echo html_escape($case_study->reference); ?></td>
                                    <td><?php echo ((html_escape($case_study->status)==1)?display('active'):display('inactive')); ?></td>
                                    <td class="center">
