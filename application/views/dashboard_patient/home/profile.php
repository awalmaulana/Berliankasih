                ...
                <div class="row">
                    ...
                    <div class="col-sm-8"> 
                        ...
                        <?php if(!empty($user->patient_id)) { ?>
                            <dt><?php echo display('patient_id') ?></dt><dd><?php echo html_escape($user->patient_id) ?></dd>
                        <?php } ?>
                        ...
                        <?php if(!empty($user->blood_group)) { ?>
                            <dt><?php echo display('blood_group') ?></dt><dd><?php echo html_escape($user->blood_group) ?></dd>
                        <?php } ?>

                        <?php if(!empty($user->date_of_birth)) { ?>
                            <dt><?php echo display('date_of_birth') ?></dt><dd><?php echo html_escape($user->date_of_birth) ?></dd>
                        <?php } ?> 
