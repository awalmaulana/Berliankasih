                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard_patient/home/form/','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="email" class="form-control" type="email" placeholder="<?php echo display('email')?>" id="email"  value="<?php echo html_escape($patient->email) ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="date_of_birth" class="form-control dropdown-month-years" type="text" placeholder="<?php echo display('date_of_birth') ?>" id="date_of_birth"  value="<?php echo html_escape($patient->date_of_birth) ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <textarea name="address" class="form-control" id="address" placeholder="<?php echo display('address') ?>" maxlength="140" rows="7"><?php echo html_escape($patient->address) ?></textarea>
                                </div>
                            </div> 
