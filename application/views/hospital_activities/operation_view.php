                        ...
                        <?php if (!empty($operations)) { ?>
                            ...
                            <?php foreach ($operations as $operation) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($operation->patient_id); ?></td>
                                    <td><?php echo html_escape($operation->title); ?></td>
                                    <td><?php echo html_escape(character_limiter($operation->description, 60)); ?></td>
                                    <td><?php echo html_escape($operation->doctor_name); ?></td>
                                    <td><?php echo ((html_escape($operation->status)==1)?display('active'):display('inactive')); ?></td>
