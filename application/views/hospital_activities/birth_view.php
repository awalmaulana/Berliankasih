                        ...
                        <?php if (!empty($births)) { ?>
                            ...
                            <?php foreach ($births as $birth) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($birth->patient_id); ?></td>
                                    <td><?php echo html_escape($birth->title); ?></td>
                                    <td><?php echo html_escape(character_limiter($birth->description, 60)); ?></td>
                                    <td><?php echo html_escape($birth->doctor_name); ?></td>
                                    <td><?php echo ((html_escape($birth->status)==1)?display('active'):display('inactive')); ?></td>
