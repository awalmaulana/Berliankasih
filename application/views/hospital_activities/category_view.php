                        ...
                        <?php if (!empty($categorys)) { ?>
                            ...
                            <?php foreach ($categorys as $category) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo html_escape(character_limiter(strip_tags($category->description),50)); ?></td>
                                    <td><?php echo ((html_escape($category->status)==1)?display('active'):display('inactive')); ?></td>
