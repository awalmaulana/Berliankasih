                        ...
                        <?php if (!empty($medicines)) { ?>
                            ...
                            <?php foreach ($medicines as $medicine) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($medicine->name); ?></td>
                                    <td><?php echo html_escape($medicine->category); ?></td>
                                    <td><?php echo html_escape(character_limiter(strip_tags($medicine->description),50)); ?></td>
                                    <td><?php echo html_escape($medicine->price); ?></td>
                                    <td><?php echo html_escape($medicine->manufactured_by); ?></td>
                                    <td><?php echo ((html_escape($medicine->status)==1)?display('active'):display('inactive')); ?></td>
