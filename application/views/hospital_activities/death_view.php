                        ...
                        <?php if (!empty($deaths)) { ?>
                            ...
                            <?php foreach ($deaths as $death) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($death->patient_id); ?></td>
                                    <td><?php echo html_escape($death->title); ?></td>
                                    <td><?php echo html_escape(character_limiter($death->description, 60)); ?></td>
                                    <td><?php echo html_escape($death->doctor_name); ?></td>
                                    <td><?php echo ((html_escape($death->status)==1)?display('active'):display('inactive')); ?></td>
