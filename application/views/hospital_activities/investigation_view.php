                        ...
                        <?php if (!empty($investigations)) { ?>
                            ...
                            <?php foreach ($investigations as $investigation) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><img src="<?php echo (!empty($investigation->picture) ? base_url(html_escape($investigation->picture)) : base_url("assets/images/no-img.png")) ?>" width="65" height="50"/></td>

                                    <td><?php echo html_escape($investigation->patient_id); ?></td>
                                    <td><?php echo html_escape($investigation->title); ?></td>
                                    <td><?php echo html_escape(character_limiter($investigation->description, 60)); ?></td>
                                    <td><?php echo html_escape($investigation->doctor_name); ?></td>
                                    <td><?php echo ((html_escape($investigation->status)==1)?display('active'):display('inactive')); ?></td>
