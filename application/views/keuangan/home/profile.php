            ...
            <div class="panel-body">  
                <div class="row">
                    ...
                    <div class="col-sm-4" align="center"> 
                        <img alt="Picture" src="<?php echo (!empty($user->picture)?base_url(html_escape($user->picture)):base_url("assets/images/no-img.png")) ?>" width="150" height="150">
                        <h3>
                    ...
                    <div class="col-sm-8"> 
                        ...
                        <?php if(!empty($user->address)) { ?>
                            <dt><?php echo display('address') ?></dt><dd><?php echo html_escape($user->address); ?></dd>
                        <?php } ?> 

                        <?php if(!empty($user->phone)) { ?>
                            <dt><?php echo display('phone') ?></dt><dd><?php echo html_escape($user->phone); ?></dd>
                        <?php } ?> 

                        <?php if(!empty($user->mobile)) { ?>
                            <dt><?php echo display('mobile') ?></dt><dd><?php echo html_escape($user->mobile); ?></dd>
                        <?php } ?> 
                        ...
                        <?php if(!empty($user->create_date)) { ?>
                            <dt><?php echo display('create_date') ?></dt><dd><?php echo html_escape($user->create_date); ?></dd>
                        <?php } ?>  
  
                        <?php if(!empty($user->update_date)) { ?>
                            <dt><?php echo display('update_date') ?></dt><dd><?php echo html_escape($user->update_date); ?></dd>
                        <?php } ?>  
