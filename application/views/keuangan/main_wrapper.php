    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
            <header class="main-header"> 
                ...
                <a href="<?php echo base_url('keuangan/home') ?>" class="logo"> <!-- Logo -->
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown dropdown-user">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo base_url('keuangan/home/profile'); ?>"><i class="pe-7s-users"></i> <?php echo display('profile') ?></a></li>
                                    <li><a href="<?php echo base_url('keuangan/home/form'); ?>"><i class="pe-7s-settings"></i> <?php echo display('edit_profile') ?></a></li>
                                    <li><a href="<?php echo base_url('dashboard/resetPassword') ?>"><i class="pe-7s-key"></i> <?php echo display('update').' '.display('password') ?></a></li>
                                    <li><a href="<?php echo base_url('keuangan/home/logout') ?>"><i class="pe-7s-power"></i> <?php echo display('logout') ?></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu"> 
                        <li class="<?php echo (($this->uri->segment(2) == 'home') ? "active" : null) ?>">
                            <a href="<?php echo base_url('keuangan/home') ?>"><i class="fa ti-home"></i> <?php echo display('dashboard') ?></a>
                        </li> 
  

                        <li class="<?php echo (($this->uri->segment(2) == 'noticeboard') ? "active" : null) ?>">
                            <a href="<?php echo base_url('keuangan/noticeboard/notice') ?>"><i class="fa fa-bell"></i> <?php echo display('noticeboard') ?></a>
                        </li>  

                        <li class="<?php echo (($this->uri->segment(2) == 'patient') ? "active" : null) ?>">
                            <a href="<?php echo base_url("keuangan/patient/patient") ?>"><i class="fa fa-wheelchair"></i> <?php echo display('patient') ?></a>
                        </li>  
   
                        <li class="treeview <?php echo (($this->uri->segment(2) == "account_manager") ? "active" : null) ?>">
                            <a href="#">
                                <i class="fa fa-money"></i><span><?php echo 'Management Keuangan' ?></span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("keuangan/account_manager/account/create") ?>"><?php echo display('add_account') ?></a></li>
                                <li><a href="<?php echo base_url("keuangan/account_manager/account") ?>"><?php echo display('account_list') ?></a></li> 
                                <li><a href="<?php echo base_url("keuangan/account_manager/invoice/create") ?>"><?php echo display('add_invoice') ?></a></li>
                                <li><a href="<?php echo base_url("keuangan/account_manager/invoice") ?>"><?php echo display('invoice_list') ?></a></li> 
                                <li><a href="<?php echo base_url("keuangan/account_manager/payment/create") ?>"><?php echo display('add_payment') ?></a></li>
                                <li><a href="<?php echo base_url("keuangan/account_manager/payment") ?>"><?php echo display('payment_list') ?></a></li> 
                                <li><a href="<?php echo base_url("keuangan/account_manager/report") ?>"><?php echo display('report') ?></a></li>
                                <li><a href="<?php echo base_url("keuangan/account_manager/report/debit") ?>"><?php echo display('debit_report') ?></a></li> 
                                <li><a href="<?php echo base_url("keuangan/account_manager/report/credit") ?>"><?php echo display('credit_report') ?></a></li> 
                            </ul>
                        </li>
                        ...
                        <li class="treeview <?php echo (($this->uri->segment(2) == "messages") ? "active" : null) ?>">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url("keuangan/messages/message/new_message") ?>"> <?php echo display('new_message') ?> </a></li> 
                                <li><a href="<?php echo base_url("keuangan/messages/message") ?>"> <?php echo display('inbox') ?> </a></li> 
                                <li><a href="<?php echo base_url("keuangan/messages/message/sent") ?>"><?php echo display('sent') ?> </a></li>
                            </ul>
                        </li>
