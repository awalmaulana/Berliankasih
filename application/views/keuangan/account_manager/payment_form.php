                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open('dashboard_accountant/account_manager/payment/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('account_id',html_escape($credit_acc_list) , $payment->account_id, ' class="form-control" id="account_name" ');  ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="amount"  type="text" class="form-control" id="amount" placeholder="<?php echo display('amount') ?>" value="<?php echo html_escape($payment->amount) ?>">
                                </div>
                            </div>                            
