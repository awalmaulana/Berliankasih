                                ...
                                <tr>  
                                    <th width="40%">
                                        <ul class="list-unstyled"> 
                                            <li>
                                                ...
                                                <?php echo html_escape($invoice->patient_id) ?></span>
                                            </li>   
                                            <li><strong><?php echo display('full_name') ?></strong> 
                                                <span class="invoice-input">
                                                <?php echo html_escape($invoice->firstname); ?> <?php echo html_escape($invoice->lastname) ?></span>
                                            </li>  
                                            <li> 
                                            <strong><?php echo display('address') ?>&nbsp;&nbsp;&nbsp;&nbsp;</strong>
                                                <span class="invoice-input">
                                                <?php echo html_escape($invoice->address) ?></span>
                                            </li>  
                                        </ul>
                                    </th>  
                                    ...
                                    <th width="40%">
                                        <h4>
                                            ...
                                            <span class="invoice-input"><?php echo html_escape(date('d-m-Y', strtotime($invoice->date))); ?></span><br> 
                        ...
                        <table id="invoice" class="table table-striped"> 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo html_escape(sprintf('%0.2f', $value->quantity)); ?></td>
                                    <td><?php echo html_escape(sprintf('%0.2f', $value->price) );?></td>
                                    <td class="text-center"><?php echo html_escape(sprintf('%0.2f', $value->subtotal)); ?></td>
                                </tr>
                                <?php
                                    }
                                }
                            ...
                            <tfoot> 
                                <tr class="bg-info">  
                                    ...
                                    <th class="text-center"><?php echo html_escape(sprintf('%0.2f', $invoice->total));?></th>   
                                </tr>
                                <tr>  
                                    <td colspan="3"></td> 
                                    <th><?php echo display('vat') ?></th>
                                    <th class="text-center"><?php echo html_escape(sprintf('%0.2f', $invoice->vat)) ?></th>    
                                </tr>
                                <tr>  
                                    <td colspan="3"></td> 
                                    <th><?php echo display('discount') ?></th>
                                    <th class="text-center"><?php echo html_escape(sprintf('%0.2f', $invoice->discount)) ?></th>    
                                </tr>
                                <tr class="bg-success">  
                                    <td colspan="3"></td> 
                                    <th><?php echo display('grand_total') ?></th>
                                    <th class="text-center"><?php echo html_escape(sprintf('%0.2f', $invoice->grand_total));?></th>    
                                </tr>
                                <tr>  
                                    <td colspan="3"></td> 
                                    <th><?php echo display('paid') ?></th>
                                    <th class="text-center"><?php echo html_escape(sprintf('%0.2f', $invoice->paid)); ?></th>    
                                </tr>
                                <tr class="bg-danger">
                                    <td colspan="3"></td> 
                                    <th><?php echo display('due') ?></th>
                                    <th class="text-center"><?php echo html_escape(sprintf('%0.2f', $invoice->due)); ?></th>    
                                </tr> 
                            </tfoot>
                        </table>  
                        <?php echo form_close() ?>
