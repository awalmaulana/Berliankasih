                    ...
                    <tbody>
                        <?php if (!empty($insurances)) { ?>
                            ...
                            <?php foreach ($insurances as $insurance) { ?>
                                <tr>
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($insurance->insurance_name); ?></td>
                                    <td><?php echo html_escape($insurance->service_tax); ?></td>
                                    <td><?php echo html_escape($insurance->discount); ?></td>
                                    <td><?php echo html_escape($insurance->insurance_no); ?></td>
                                    <td><?php echo html_escape($insurance->insurance_code); ?></td> 
                                    <td><?php echo html_escape($insurance->hospital_rate); ?></td> 
                                    <td><?php echo html_escape($insurance->insurance_rate); ?></td> 
                                    <td><?php echo html_escape($insurance->total); ?></td> 
                                    <td><?php echo ((html_escape($insurance->status)==1)?display('active'):display('inactive')); ?></td>
                                    <td class="center">
