            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open_multipart('insurance/limit_approval/update/'.html_escape($approval->id)) ?>
                            <?php echo form_hidden('id', html_escape($approval->id)); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <?php 
                                    $disease_details = json_decode(html_escape($approval->disease_details), true);
                            ...
                            <div class="form-group row">
                                ...
                                <?php 
                                    $approval_breakup = json_decode(html_escape($approval->approval_breakup), true);
                                ...
                                <div class="row" class="insc-mb-10">
                                    ...
                                    <div class="col-xs-4">
                                        <input name="breakup_charge[]" type="number" class="form-control"  placeholder="<?php echo display('disease_charge') ?>" value="<?php echo $value ?>" >
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="btn-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="total" type="number" class="form-control" id="total" placeholder="<?php echo display('total') ?>" value="<?php echo $approval->total ?>" >
                                </div>
                            </div> 
...
<script src="<?php echo base_url('assets/js/admin/insurance/limit_approval_update.js?v=1') ?>" type="text/javascript"></script>