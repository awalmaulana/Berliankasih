                    ...
                    <tbody>
                        <?php if (!empty($approvals)) { ?>
                            ...
                            <?php foreach ($approvals as $approval) { ?>
                                <tr>
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo html_escape($approval->patient_id); ?></td>
                                    <td><?php echo html_escape($approval->consultant_name); ?></td>
                                    <td><?php echo html_escape($approval->policy_name); ?></td>
                                    <td><?php echo html_escape($approval->policy_no); ?></td>
                                    <td><?php echo html_escape($approval->policy_holder_name); ?></td>
                                    <td><?php echo html_escape($approval->insurance_name); ?></td>
                                    <td><?php echo html_escape($approval->total); ?></td> 
                                    <td><?php echo ((html_escape($approval->status)==1)?display('active'):display('inactive')); ?></td>
                                    <td class="center">
