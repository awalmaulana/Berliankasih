                    ...
                    <div class="col-md-9 col-sm-12">
                        <?php echo form_open('appointment/create','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <?php echo form_dropdown('department_id',$department_list,html_escape($appointment->department_id),'class="form-control" id="department_id"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9"> 
                                    <input name="date" type="text" class="datepicker-avaiable-days form-control" id="date" placeholder="<?php echo display('appointment_date') ?>" autocpmplete="off">
                                </div>
                            </div>
