...
class Bill extends CI_Controller {
	...
	public function form()
	{
		...
		$data['bill'] = (object)$postData = array(
			...
			'card_cheque_no' => $this->input->post('card_cheque_no', true),
		...
		if ($this->form_validation->run()) {
			...
			if ($this->bill_model->create($postData)) {
				...
				#------------bill details--------------#
				$sID   = $this->input->post('service_id', true);
				$sName = $this->input->post('service_name', true);
				$sQty  = $this->input->post('quantity', true);
				$sAmt  = $this->input->post('amount', true);
				$services = array();
	...
	public function serviceList(){
		$service_list = $this->service_model->getServiceList();
	...
	public function edit($bill_id = null)
	{
		...
		#-------------------------------#
		$admission_id = $this->input->post('bill_id', true);
		$admission_id = $this->input->post('admission_id', true);
		$package_id   = $this->input->post('package_id', true);
		#-------------------------------#
		$data['bill'] = (object)$postData = array(
