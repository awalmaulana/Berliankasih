...
class Account extends CI_Controller {
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/account',$data,true);
	...
	{ 
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['id'])) {
				...
				redirect('keuangan/account_manager/account/create');
			} else {
				...
				redirect('keuangan/account_manager/account/edit/'.$postData['id']);
			}

		} else {
			$data['content'] = $this->load->view('keuangan/account_manager/account_form',$data,true);
			$this->load->view('keuangan/main_wrapper',$data);
		} 
	}
	...
	public function delete($id = null) 
	{
		...
		redirect('keuangan/account_manager/account');
	}
