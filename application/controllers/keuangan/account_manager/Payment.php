...
class Payment extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			...
			'keuangan/account_manager/payment_model'
		));
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/payment',$data,true);
	...
	{ 
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['id'])) {
				...
				redirect('keuangan/account_manager/payment/create');
			} else {
				...
				redirect('keuangan/account_manager/payment/edit/'.$postData['id']);
			}

		} else {
			$data['credit_acc_list'] = $this->account_model->credit_acc_list();
			$data['content'] = $this->load->view('keuangan/account_manager/payment_form',$data,true);
			$this->load->view('keuangan/main_wrapper',$data);
		} 
	}
	...
	public function delete($id = null) 
	{
		...
		redirect('keuangan/account_manager/payment');
	}
