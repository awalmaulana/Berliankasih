...
class Report extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'keuangan/account_manager/report_model',
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/report', $data, true);
	...
	public function debit()
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/report_debit', $data, true);
		$this->load->view('keuangan/main_wrapper',$data);
	} 
	...
	public function credit()
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/report_credit', $data, true);
		$this->load->view('keuangan/main_wrapper',$data);
	} 
