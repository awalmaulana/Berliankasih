...
class Invoice extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'keuangan/account_manager/account_model',
			'keuangan/account_manager/invoice_model'
		));
	...
	public function index()
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/invoice',$data,true);
		$this->load->view('keuangan/main_wrapper',$data);
	} 
	...
	{  
		...
		if ($this->form_validation->run() === true) {
			...
			if ($this->invoice_model->create($invoiceData)) {
				...
				redirect('keuangan/account_manager/invoice/view/'.$invoice_id);

			} else {
				#set exception message
				$this->session->set_flashdata('exception',display('please_try_again'));
			}
			redirect('keuangan/account_manager/invoice/create');
			

		} else {
			$data['website'] = $this->invoice_model->website();
			$data['debit_account_list'] = $this->account_model->debit_acc_list();
			$data['content'] = $this->load->view('keuangan/account_manager/invoice_form',$data,true);
			$this->load->view('keuangan/main_wrapper',$data);
		} 
	}
	...
	public function view($id = null) 
	{
		...
		$data['content'] = $this->load->view('keuangan/account_manager/invoice_view',$data,true);
		$this->load->view('keuangan/main_wrapper',$data);
	}
	...
	public function edit($id = null) 
	{
		...
		if ($this->form_validation->run() === true) {
			...
			redirect('keuangan/account_manager/invoice/edit/'.$invoice_id);
			...
			$data['invoice'] = $this->invoice_model->single_view($id);
			$data['invoice_data'] = $this->invoice_model->invoice_data($id);
			$data['content'] = $this->load->view('keuangan/account_manager/invoice_edit',$data,true);
			$this->load->view('keuangan/main_wrapper',$data);
		} 
	}
	...
	public function delete($id = null) 
	{
		...
		redirect('keuangan/account_manager/invoice');
	}
