...
class Message extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
            'keuangan/messages/message_model' 
		));
    ...
    public function index()
    {
        ...
        $data['content']  = $this->load->view('keuangan/messages/inbox' ,$data,true);
	...
	public function sent()
	{
		...
		$data['content'] = $this->load->view('keuangan/messages/sent' ,$data,true);
		$this->load->view('keuangan/main_wrapper',$data);
	} 
    ...
    {  
        ...
        $data['content'] = $this->load->view('keuangan/messages/inbox_information',$data,true);
        $this->load->view('keuangan/main_wrapper',$data);
    }
    ...
    {  
        ...
        $data['content'] = $this->load->view('keuangan/messages/sent_information',$data,true);
        $this->load->view('keuangan/main_wrapper',$data);
    }
    ...
    { 
        ...
        if ($this->form_validation->run() === true) { 
            ...
            redirect('keuangan/messages/message/new_message');
        } else {
            $data['title'] = display('new_message');
            $data['user_list'] = $this->message_model->user_list($user_id);
            $data['content'] = $this->load->view('keuangan/messages/new_message',$data,true);
            $this->load->view('keuangan/main_wrapper',$data);
        }  
    }
