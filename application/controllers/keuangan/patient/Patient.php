...
class Patient extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'keuangan/patient/patient_model'
		));
	...
	{  
		...
		$data['content'] = $this->load->view('keuangan/patient/patient',$data,true);
	...
	{ 
		...
		$data['content'] = $this->load->view('keuangan/patient/patient_profile',$data,true);
		$this->load->view('keuangan/main_wrapper',$data);
	}
