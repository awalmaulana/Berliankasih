...
class Home extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['content'] = $this->load->view('keuangan/home/dashboard',$data,true);
    ...
    {  
        ...
        $data['content'] = $this->load->view('keuangan/home/profile', $data, true);
        $this->load->view('keuangan/main_wrapper',$data);
    } 
