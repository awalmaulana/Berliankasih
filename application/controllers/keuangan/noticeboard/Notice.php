...
class Notice extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'keuangan/noticeboard/notice_model'
		));
	...
	{  
		...
		$data['content'] = $this->load->view('keuangan/noticeboard/view',$data,true);
	...
	{   
		...
		$data['content'] = $this->load->view('keuangan/noticeboard/details',$data,true);
		$this->load->view('keuangan/main_wrapper',$data);
	} 
