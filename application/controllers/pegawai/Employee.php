...
class Employee extends CI_Controller {
	...
	{ 	 
		...
		$data['content'] = $this->load->view('pegawai/view', $data, true);
	...
	{  
        ...
        if (empty($user_id)) {
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('pegawai/employee/form');
            } else {
            	//view section
				$data['title'] = display('add_employee');
                $data['userRoles'] = $this->user_roles();
                $data['content'] = $this->load->view('pegawai/form',$data,true);
                $this->load->view('layout/main_wrapper',$data);
            } 
            ...
            if ($this->form_validation->run() === true) { 
                ...
                redirect('pegawai/employee/form/'.$postData['user_id']);
            } else {
            	//view section
	...
	{   
        ...
        if ($this->form_validation->run() === true) { 
            ...
            $data['employee'] = $this->employee_model->read_by_id($user_id);
            $data['userRoles'] = $this->user_roles(); 
            $data['content'] = $this->load->view('pegawai/profile_edit',$data,true);
            $this->load->view('layout/main_wrapper',$data);
        } 
	}
}
