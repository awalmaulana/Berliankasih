...
class Dokter extends CI_Controller {
	...
	{  
		...
		$data['doctors'] = $this->dokter_model->read();
		$data['content'] = $this->load->view('dokter',$data,true);
	...
	public function create()
	{
		...
		if ($this->form_validation->run() === true) {
			...
			if (empty($postData['user_id'])) {
				if ($this->dokter_model->create($postData)) {
					#set success message
				...
				if ($this->dokter_model->update($postData)) {
					#set success message
				...
				redirect('dokter/edit/'.$postData['user_id']);
			}

		} else {
			$data['department_list'] = $this->poliklinik_model->department_list(); 
			$data['content'] = $this->load->view('dokter_form',$data,true);
			$this->load->view('layout/main_wrapper',$data);
		} 
	}
	...
	{ 		 
		...
		#-------------------------------#
		$data['user'] = $this->dokter_model->read_by_id($user_id);
		$data['content'] = $this->load->view('dokter_profile',$data,true);
		$this->load->view('layout/main_wrapper',$data);
	}
	...
	public function edit($user_id = null) 
	{
		...
		#-------------------------------#
		$data['department_list'] = $this->poliklinik_model->department_list(); 
		$data['doctor'] = $this->dokter_model->read_by_id($user_id);
		#-------------------------------#
	...
	{ 
		if ($this->dokter_model->delete($user_id)) {
			#set success message
