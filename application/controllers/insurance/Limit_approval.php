...
class Limit_approval extends CI_Controller {
	...
	public function form()
	{
		...
		#-------------------------------#
		$DName   = $this->input->post('disease_name', true);
		$DCharge = $this->input->post('disease_details', true);
		...
		#-------------------------------#
		$BName   = $this->input->post('breakup_name', true);
		$BCharge = $this->input->post('breakup_charge', true);
		...
		$data['approval'] = (object)$postData = array(
			...
			'consultant_id'   => $this->input->post('consultant_id', true), 
			'policy_name'     => $this->input->post('policy_name', true), 
			'policy_no'       => $this->input->post('policy_no', true), 
			'policy_holder_name'  => $this->input->post('policy_holder_name', true), 
