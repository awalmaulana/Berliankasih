...
class Patient extends CI_Controller {
	...
	public function form($id = null)
	{
		...
		$data['patient'] = (object)$postData = array(
			...
			'patient_id'      => (($this->input->get('pid', true)!=null)?$this->input->get('pid', true):$this->input->post('patient_id', true)),
			'case_manager_id' => $this->input->post('case_manager_id', true),
			'ref_doctor_id'   => $this->input->post('ref_doctor_id', true),
			'hospital_name'   => $this->input->post('hospital_name', true),
			'doctor_name' 	  => $this->input->post('doctor_name', true),
			'hospital_address' => $this->input->post('hospital_address', true),
	...
	{ 
        ...
        $data['status'] = (object)$postData = array( 
            'id'              => $this->input->post('id', true),
            'cm_patient_id'   => $this->input->post('cm_patient_id', true),
            'description'     => $this->input->post('description', true),
            'critical_status' => $this->input->post('critical_status', true),
        );
